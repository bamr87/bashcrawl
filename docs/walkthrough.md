...
Prefer a browser? Run `make web-preview` (or open `web/index.html`) to play the
static web trainer instead.

You begin in the **bashcrawl lobby** — the root directory of the game
