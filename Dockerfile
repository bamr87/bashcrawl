...
# ║                                                                           ║
# ║  Multi-stage build for game, TUI, viewer, web (MCP), linting, and tests  ║
# ╚═══════════════════════════════════════════════════════════════════════════╝
#
# Targets:
...
#   docker build --target web -t bashcrawl-web .
...
# ============================================================================
# Stage: web — full tree + web UI and MCP (matches PR #19 single-stage flow)
# ============================================================================
